...
<article>
    ...
    <form id="news" method = "post" onsubmit = "return checknew();" name="newt"/ > 
    
    正文：（字数统计：<span class="word_count">0</span>）
    <textarea id="editor_id" name="talk"></textarea>
     
    <input class="article_button" type="submit" value="提交" name="newt"/>
  </form>  
