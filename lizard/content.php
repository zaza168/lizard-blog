...
if($id)
 { 
echo "<script>location.href='content.php';</script>"; 
}
$num_query=mysql_query("select count(id) from l_content ");//查询数据库总条数
$pagesize=10;//定义每个页面显示的条数
$content=mysql_fetch_array($num_query);
$count=$content[0];//总条数
$page=empty($_GET['page'])?1:$_GET["page"];//显示当前页
//显示当页面信息页面
$sql="select * from l_content limit ".($page-1)*$pagesize.",".$pagesize;
    ...
    <ul>
		<li>
			...
			<ul class="left_menu_sub1">
				<li class="sub1_color"><a href="content.php">所有留言</a></li>
   ...
   <!-- <div class="article_function">
	...
	<table id="article_table" border="0" cellpadding="0" cellspacing="0">
		...
		echo "<tr>";
			...
			echo '<td>
					<a href="content.php?id='.$content[0].'">删除</a>
				 </td>';
			echo "</tr>";
		}	
			}else{
