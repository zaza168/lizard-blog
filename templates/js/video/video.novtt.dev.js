...
vjs.options = {
  ...
  'language': document.getElementsByTagName('html')[0].getAttribute('lang') || navigator.languages && navigator.languages[0] || navigator.userLanguage || navigator.language || 'zh-CN',
...
vjs.MediaError.defaultMessages = {
  1: '你取消了视频播放。',
  2: '网络错误导致部分视频下载失败。',
  3: '视频播放被中止，可能是因为视频的问题，也许您的浏览器不支持。',
  4: '视频无法加载，因为服务器网络故障或由于格式不支持。',
  5: '视频是加密的，暂无法播放。'
};
